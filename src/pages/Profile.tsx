...
import { User, Lock, Edit2, LayoutDashboard, Calendar, Settings, HelpCircle, LogOut, ArrowRight, ShieldCheck } from 'lucide-react';
      ...
      <aside className="w-full md:w-72 bg-white flex flex-col p-6 gap-2 sticky top-20 h-auto md:h-[calc(100vh-80px)] border-r border-outline-variant/10">
        ...
        <nav className="flex flex-col gap-1 flex-1">
          {[
            ...
            { name: 'My Bookings', icon: Calendar, active: false },
            ...
            >
              <item.icon className={cn("w-5 h-5", item.active ? "text-white" : "text-primary group-hover:scale-110 transition-transform")} />
